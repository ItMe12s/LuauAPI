...
from broma_parser import Arg, Class, Field, Function, Method, parse_file  # type: ignore[import-unresolved]
...
from free_fn_overrides import free_fn_allowed  # type: ignore[import-unresolved]
...
import type_map as type_map_module  # type: ignore[import-unresolved]
from type_map import (  # type: ignore[import-unresolved]
    COCOS_ENUM_TYPES,
    GD_ENUM_TYPES,
    GEODE_ENUM_TYPES,
