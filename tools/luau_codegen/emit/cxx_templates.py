...
def emit_internal_hpp() -> str:
    return (
        ...
        "    return true;\n"
        "}\n\n"
        "inline void adoptMacHookThread(char const* location, char const* message) {\n"
        "#if defined(GEODE_IS_MACOS)\n"
        "    if (!luax::Runtime::isMainThread()) {\n"
        "        // #region agent log\n"
        '        luax::Runtime::debugThreadProbe("post-fix", "H2,H4", location, message);\n'
        "        // #endregion\n"
        ...
        '    adoptMacHookThread("generated:runLuaPreHooks", "adopting generated pre-hook thread as runtime owner");\n'
        "    static std::atomic_bool s_loggedFirstPreHook{false};\n"
        "    bool expected = false;\n"
        "    if (s_loggedFirstPreHook.compare_exchange_strong(expected, true)) {\n"
        "        // #region agent log\n"
        '        luax::Runtime::debugThreadProbe("initial", "H2,H4", "generated:runLuaPreHooks", "first generated pre-hook Lua entry");\n'
        "        // #endregion\n"
        "    }\n"
        ...
        '    adoptMacHookThread("generated:runLuaPostHooks", "adopting generated post-hook thread as runtime owner");\n'
        "    static std::atomic_bool s_loggedFirstPostHook{false};\n"
        "    bool expected = false;\n"
        "    if (s_loggedFirstPostHook.compare_exchange_strong(expected, true)) {\n"
        "        // #region agent log\n"
        '        luax::Runtime::debugThreadProbe("initial", "H2,H4", "generated:runLuaPostHooks", "first generated post-hook Lua entry");\n'
        "        // #endregion\n"
        "    }\n"
        "    auto it = hookStates().find(targetId);\n"
